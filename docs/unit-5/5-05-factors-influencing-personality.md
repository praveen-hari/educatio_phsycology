...
```mermaid
flowchart LR
    A[Physical Characteristics] --> B[Self-Concept/Self-Esteem]
    B --> C[Personality Development]
...
```mermaid
flowchart TB
    subgraph GLANDS["🧪 Ductless Glands"]
        A[Thyroid]
        B[Parathyroid]
        C[Pituitary]
        D[Sex Glands]
    ...
    A & B & C & D & E --> F & G & H
    F & G & H --> I[Bodily, Mental & Emotional Development]
...
```mermaid
flowchart TB
    subgraph CULTURE["🌍 Cultural Components"]
        A[Occupation]
        B[Marriage]
        C[Interpersonal Relationships]
    end
    
    A & B & C --> D[Shaped by Social Agencies]
    
    style CULTURE fill:#fff3e0,stroke:#ff9800
```
...
flowchart TB
    ...
    A & B & C & D & E & F --> G[Personality Development]
    
    style PSYCHOLOGICAL fill:#e3f2fd,stroke:#2196f3,stroke-width:2px
```
